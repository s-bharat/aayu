...
export const selectorName = 'Partmasterdata_Save';
export const getSaveStateSelector = createFeatureSelector<SaveState>(selectorName);

export function SaveReducer(
  state: SaveState = initialSaveState,
  action: actions.SaveAction): SaveState {
  switch (action.type) {
